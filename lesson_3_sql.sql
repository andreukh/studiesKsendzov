...
--вывести все телефоны эппл, которые дороже, чем средняя цена телефона самсунг(нужно выводить одно число, с которым сравниваем)
...
-- сравнение со списком, меньше меньшего, и больше большего

select * from phones_samsung
where price < any (select price from phones_apple where price < 1000)

-- сравнение со списком, меньше большего, и больше меньшего(any)
